...
sed = logging.getLogger("White Devil X")
...
print("White Devil has been deployed! ")

print("Setting up White Devil")
...
if Config.ENABLE_ASSISTANTBOT == "ENABLE":
    ...
    sed.info("White Devil X Bot Have Been Installed Successfully !")
else:
    sed.info("White Devil X Has Been Installed Sucessfully !")
    sed.info("You Can Visit @whitedevil_UB For Any Support Or Doubts")
