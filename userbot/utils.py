...
def errors_handler(func):
    async def wrapper(errors):
        try:
            ...
            link = "[Here](https://t.me/whitedevil_UB)"
            ...
            ftext += "--------BEGIN WHITE DEVIL X USERBOT TRACEBACK LOG--------"
            ftext += "\nDate: " + date
...
def start_assistant(shortname):
    if shortname.startswith("__"):
        ...
        spec.loader.exec_module(mod)
        sys.modules[
            "userbot.plugins.assistant" + "Initialising White Devil X" + shortname
        ] = mod
        sedprint.info("White Devil Has imported " + shortname)
...
def load_assistant(shortname):
    if shortname.startswith("__"):
        ...
        mod = importlib.util.module_from_spec(spec)
        spec.loader.exec_module(mod)
        print("Initialising White Devil X.")
        print("White Devil X - Imported " + shortname)
    else:
        import importlib
        import sys
        from pathlib import Path
        ...
        print("White Devil X Has imported " + shortname)
